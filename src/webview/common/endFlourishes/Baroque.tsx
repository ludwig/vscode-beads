/**
 * Baroque — a wide, symmetric scrollwork divider: twin volutes per side with
 * acanthus leaves, a fine tendril, graduated beads, and a central
 * medallion-and-lozenge cartouche framing a bead. Part of the end-flourish
 * library (see ./index).
 */
...
export function Baroque(): React.ReactElement {
  return (
    <svg
      className="view-end-flourish view-end-baroque"
      viewBox="0 0 440 48"
      width="380"
      height="41"
      role="presentation"
