...
- **Sidebar view title tracks the screen** — the merged sidebar view now shows the **bead id** in its header while a bead's Details are open (was stuck on "Repository" regardless of screen); it reads "Repository" on the Project screen
