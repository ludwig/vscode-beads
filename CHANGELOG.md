...
- New **Tree** tab in the bottom Beads panel — a file-explorer-style hierarchical tree of beads keyed on parent-child relationships (expand/collapse, indentation) with a filter line that narrows to matching beads while keeping the path to them (vs-bw9)
