...
- **"Show Tree" sidebar action** — a new button next to "Show Issues" reveals the Beads panel with the Tree tab focused (styled as an outlined peer of Show Issues), mirroring the existing Show-Issues/Show-Kanban focus flow
